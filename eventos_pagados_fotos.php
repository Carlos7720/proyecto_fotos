...
//pull out all user form database
 ...
 $resp=array();
 $all_users = find_eventos_cliente_fotos_compradas($id_cliente, $id_evento,$resp);
// print_r($resp); 
?>
...
<img src="<?php echo 'eventos/evento_'.$id_evento.'/'.$a_user[15]; ?>"  
 style="width: 200px; height: 150px" >
           ...
           <td class="text-center">
               <a href="http://<?php echo IP_URL;?>/negocio/<?php echo 'eventos/evento_'.$id_evento.'/'.$a_user[15];?>"  
                       download="<?php echo 'evento_'.$id_evento.'/'.$a_user[15];;?>">Descargar</a>
           </td>
          </tr>
        <?php endforeach;?>
       </tbody>
