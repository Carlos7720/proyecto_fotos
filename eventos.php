        ...
        <?php foreach($all_users as $a_user): ?>
          <tr>
           ...
           <td class="text-center">
             <div class="btn-group">
                 <a href="edit_eventos.php?id=<?php echo (int)$a_user['id'];?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
                  <i class="glyphicon glyphicon-pencil"></i>
               </a>
                <a href="delete_eventos.php?id=<?php echo (int)$a_user['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Eliminar">
